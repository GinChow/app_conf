...
export PATH=$PATH:/usr/local/cuda-10.0/bin:$HOME/anaconda3/bin:$HOME/tools:$HOME/bin:/usr/local/bin:$HOME/anaconda3/bin
...
# bind key
parentdirectory () {cd ..; zle redisplay}
zle -N parentdirectory 
bindkey '\ek' parentdirectory
